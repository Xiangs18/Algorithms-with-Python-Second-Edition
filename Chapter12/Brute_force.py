def brute_force(text, pattern):
    ...
    flag = (
        False
    )  # If the pattern doesn't appear at all, then set this to false and execute the last if statement
